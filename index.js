...
client.on('message', async msg => {
    ...
    if (isValid != undefined) {
        ...
        if (text.includes("#sticker") && msg.hasMedia) {
            ...
            if (media) {
                msg.reply(media, msg.from, { sendMediaAsSticker: true, stickerAuthor: "Generated by GarpuBOT", stickerName: "Stickers" });
            }else{
            ...
            // msg.reply(image, msg.from, { sendMediaAsSticker: true, stickerAuthor: "Generated by GarpuBOT", stickerName: "Stickers" });

...
client.on('message', async msg => {
    ...
    if (isValid != undefined) {
        ...
        if (text.includes("#sticker") && msg.hasMedia) {
            ...
            const file = convertBase64ToFile(base64, filename + extension);
            client.sendMessage(msg.from, file, { sendMediaAsSticker: true, stickerAuthor: "Generated by GarpuBOT", stickerName: "Stickers" });
